...
//                oldSession.invalidate();
    ...
    private String getEncryptedPassword(String password) {
        ...
        } // ignored because app.server.exception is thrown if no Provider supports implementation for the specified algorithm. SHA-1 is supported.
